      ...
      <div className="max-w-6xl mx-auto mt-8">
        <Card className="w-full bg-white dark:bg-gray-800 p-5 -space-y-2">
          ...
          <div className="flex gap-3 mt-4">
            <Button className="bg-gray-300" style={{ fontFamily: "'Lobster', cursive" }} variant="outline" onClick={() => navigate(-1)}>Back</Button>
            <Button className="bg-green-800 hover:bg-green-700 dark:bg-green-400 dark:hover:bg-green-600" style={{ fontFamily: "'Lobster', cursive" }} onClick={updateBlogHandler}>
